...
## 💻 Ejercicios Prácticos (Arreglos)

**Consigna 1:** Declara un array vacío y luego otro array con 5 de tus comidas favoritas.
**[Solución]**
```javascript
const emptyArray = [];
const comidasFavoritas = ['Pizza', 'Sushi', 'Hamburguesa', 'Tacos', 'Pasta'];
console.log(comidasFavoritas);
```

**Consigna 2:** Encuentra la longitud de tu array de comidas y obtén el primer y el último elemento.
**[Solución]**
```javascript
console.log("Longitud:", comidasFavoritas.length); // 5
let primera = comidasFavoritas[0];
let ultima = comidasFavoritas[comidasFavoritas.length - 1];
console.log(primera, ultima); // Pizza Pasta
```

**Consigna 3:** Un array contiene las edades `[19, 22, 19, 24, 20, 25]`. Ordena el array de menor a mayor y encuentra la edad más joven.
**[Solución]**
```javascript
const edades = [19, 22, 19, 24, 20, 25];
edades.sort((a, b) => a - b);
console.log(edades); // [19, 19, 20, 22, 24, 25]
let masJoven = edades[0];
console.log("Más joven:", masJoven); // 19
```
